        ...
        <>
           ...
           <div style={{marginRight:'2%' , marginLeft:'2%',  marginTop:'55px', }}>
             <Row justify="start" dir="rtl" style={{border:'1px dashed #cccccc ' ,height:'55px' , borderRadius:'5px'}}>
                <Col span={7}  style={{ textAlign:'center' , marginTop:'15px',  fontFamily:'irsans',fontSize:'13px' }}>
                  12 جلسه در ماه
                </Col>
                <Col  span={9}  style={{ textAlign:'center' , marginTop:'15px',  fontFamily:'irsans', fontSize:'13px'}}>
                 400,000 تومان
                </Col>
