         ...
         <div className="Header">
                ...
                <Row>
                    ...
                    <Col span={9} style={{textAlign:'right' , paddingRight:'10px' , paddingTop:'7px' , }}>
                        <span  style={{  paddingRight:'10px' ,  color: '#6b6b6b' , paddingTop:'0px' , fontSize:'15px',  fontWeight:'600', fontFamily:'Vazir'}}>
                           رستوران
                        </span>
