    ...
    return(
         <>
                ...
                <Row style={{  height:'100vh' ,  justifyContent:'center' , alignContent:'center', alignItems:'center' , ... styles.Show}} >
                    ...
                    <div>  <Input ref={inputElementMobile} placeholder=""  type="number" value={mobile}   onChange={ChangeMobile}    maxLength={11}    prefix={<MobileOutlined  style={{ fontSize: '18px ' }} />} /> </div>
                    ...
                    <div className="StyleActiveCode"> 
                         ...
                         <Input ref={inputElement1} type="number" onKeyUp={(event)=>{  if (event.key === 'Backspace') {} else { inputElement2.current?.focus();} }} value={activeCode1} onChange={ChangeActiveCodeText1}  onFocus={()=>{ inputElement1.current?.select(); setIsActiveCode1(true)}}  onBlur={()=>{setIsActiveCode1(false)}} placeholder=""  bordered={false}  maxLength={1}  style={{ fontSize: '12px ' , marginLeft:'8%' , height:'23px' , width:'30px',  borderRadius:'0px' ,   ...styles.Focus1 }} />   
                         <Input ref={inputElement2} type="number" onKeyUp={(event)=>{  if (event.key === 'Backspace') {} else { inputElement3.current?.focus();} }} value={activeCode2} onChange={ChangeActiveCodeText2}  onFocus={()=>{ inputElement2.current?.select(); setIsActiveCode2(true)}}  onBlur={()=>{setIsActiveCode2(false)}}  placeholder=""  bordered={false}  maxLength={1}  style={{ fontSize: '12px ' , marginLeft:'6%' ,  height:'23px' , width:'30px',   borderRadius:'0px' , ...styles.Focus2  }} />   
                         <Input ref={inputElement3} type="number" onKeyUp={(event)=>{  if (event.key === 'Backspace') {} else { inputElement4.current?.focus();} }} value={activeCode3} onChange={ChangeActiveCodeText3}  onFocus={()=>{ inputElement3.current?.select(); setIsActiveCode3(true)}}  onBlur={()=>{setIsActiveCode3(false)}}  placeholder=""  bordered={false}  maxLength={1}  style={{ fontSize: '12px ' , marginLeft:'6%' ,  height:'23px' , width:'30px',   borderRadius:'0px' , ...styles.Focus3  }} />   
                         <Input ref={inputElement4} type="number" onKeyUp={(event)=>{  if (event.key === 'Backspace') {} else { inputElement5.current?.focus();} }} value={activeCode4} onChange={ChangeActiveCodeText4}  onFocus={()=>{ inputElement4.current?.select(); setIsActiveCode4(true)}}  onBlur={()=>{setIsActiveCode4(false)}}  placeholder=""  bordered={false}  maxLength={1}  style={{ fontSize: '12px ' , marginLeft:'6%' ,  height:'23px' , width:'30px',   borderRadius:'0px' , ...styles.Focus4 }} />   
                         <Input ref={inputElement5} type="number" value={activeCode5} onChange={ChangeActiveCodeText5}  onFocus={()=>{ inputElement5.current?.select(); setIsActiveCode5(true)}}  onBlur={()=>{setIsActiveCode5(false)}}  placeholder=""  bordered={false}  maxLength={1}  style={{ fontSize: '12px ' , marginLeft:'6%' ,  height:'23px' , width:'30px',   borderRadius:'0px' , ...styles.Focus5  }} />   
