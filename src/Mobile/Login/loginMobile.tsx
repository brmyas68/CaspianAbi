    ...
    return(
         <>
                ...
                <Row style={{  height:'100vh' , marginTop:'-60px' , justifyContent:'center' , alignContent:'center', alignItems:'center' , ... styles.Show}} >
                    <Col span={3}></Col>
                    <Col span={18}  >
                    <div style={{textAlign:'right' , marginBottom:'10px' , fontSize:'15px' ,  fontFamily: 'irsans'  , color:'#6b6b6b'}}>شماره موبایل</div>
                    ...
                    <div>  <Button onClick={F_SendActiveCode} size="large" type="primary" block  style={{   fontFamily: 'irsans'  ,marginTop:'12px' , fontWeight:'600'}}  >  ارسال کد </Button></div>
                    
                    <div style={{marginTop:'50px' , direction:'rtl' , paddingRight:'10px'}}>
                        <span style={{color:'red'}}>*</span>
                        <span style={{textAlign:'justify', paddingRight:'10px' ,  fontFamily: 'irsans' }}>
                    ...
                    <Col span={3}></Col>
                    <Col span={18}  >
                    <div style={{textAlign:'right' , marginBottom:'10px' , fontSize:'15px' ,  fontFamily: 'irsans'  , color:'#6b6b6b'}}>کد فعال سازی  </div>
                    ...
                    <div>  <Button onClick={F_Login} size="large" type="primary" block  style={{  fontFamily: 'irsans'  , marginTop:'12px' , fontWeight:'600'}} >   ورود   </Button></div>
                     ...
                     <div style={{marginTop:'50px' , direction:'rtl' , paddingRight:'10px'}}>
                          <span style={{color:'red'}}>*</span>
                          <span style={{ fontFamily: 'irsans'  , textAlign:'justify', paddingRight:'10px'}}>
